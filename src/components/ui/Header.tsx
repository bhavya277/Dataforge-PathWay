    ...
    <header className="sticky top-0 z-50 bg-[#F7F7F4]/95 backdrop-blur-sm border-b border-[#D9DCE1]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          >
            <div className="text-xs font-bold tracking-tight text-[#111318] uppercase">
              DATAFORGE × PATHWAY
            </div>
            <div className="text-[10px] text-[#626873] tracking-widest uppercase -mt-0.5">
              ASSOCIATIVE MEMORY LAB
            </div>
          </button>
        </div>
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`py-1 text-xs font-semibold tracking-wider transition-colors relative ${
                  isActive
                    ? "text-[#111318]"
        ...
        <div className="hidden sm:flex items-center space-x-1.5 text-[11px] font-mono text-[#626873]">
