...
| **Scaling / State Representation** | Hardware HBM bandwidth | State rank $\operatorname{Rank}(S) \le d$ | Constrained by state dimension and active support |
